        ...
        <div className={`panel-container relative group ${isFullBleed ? '!p-0 !bg-[#050505]' : ''}`}>
            ...
            {face.type === 'back_cover' && (
                <div className="absolute bottom-24 inset-x-0 flex flex-col items-center gap-4 z-20">
                    ...
                    <button onClick={(e) => { e.stopPropagation(); onReset(); }} className="comic-btn bg-[#D8B4FE] text-black border-black px-8 py-4 text-2xl font-bold hover:scale-105 uppercase animate-bounce shadow-[4px_4px_0px_white]">DROP NEXT EPISODE 💀</button>
                </div>
            )}
        </div>
    );
